...
const gameData = [{
  ...
  workName: 'Demen',
  workImg: ['img/work_img/game/d1.png', 'img/work_img/game/d2.png', 'img/work_img/game/d3.png', 'img/work_img/game/d4.png', 'img/work_img/game/d5.png', 'img/work_img/game/d6.png'],
  workInfo: '\u00A0기이한 현상들이 일어나는 집에서 퍼즐을 푸는 공포게임이다. 게임 기획과 3D 모델링, 프로젝트 관리에 참여하였다.',
}];
